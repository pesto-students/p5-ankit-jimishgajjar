...
```
In this exercise I write a function called vowelCount which accepts a string and returns a map where the keys are numbers and the values are the count of the vowels in the string.
```

#
# Question

![This is an image](https://i.postimg.cc/ZqpSksWJ/Screenshot-2022-11-03-150318.png)

# Output

![This is an image](https://i.postimg.cc/yd0cZKW2/Screenshot-2022-11-03-150433.png)
